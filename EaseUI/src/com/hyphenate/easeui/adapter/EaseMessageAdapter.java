...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowRecords;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    private static final int MESSAGE_TYPE_RECV_REXORDS = 15;
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == EMMessage.Type.TXT) {
            ...
            } else if (message.getBooleanAttribute("records", false)) {
                return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_REXORDS : MESSAGE_TYPE_SENT_RECORDS;
            }
        ...
        switch (message.getType()) {
            case TXT:
                if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    ...
                    chatRow = new EaseChatRowRecords(context,message,position,this);
                } else {
