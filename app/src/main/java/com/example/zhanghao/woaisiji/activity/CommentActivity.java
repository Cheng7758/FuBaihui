...
public class CommentActivity extends Activity {
    ...
    private void initData() {
        ...
        //网络请求
        StringRequest stringRequest=new StringRequest(Request.Method.POST, ServerAddress.URL_DETAILS, new Response.Listener<String>() {
            @Override
    ...
    class CommentAdapter extends BaseAdapter{
        ...
        @Override
        public DetailsBean.PllistBean getItem(int position) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null){
                ...
                convertView= LayoutInflater.from(CommentActivity.this).inflate(R.layout.productdetail_itme_comment,null);
            ...
            DetailsBean.PllistBean item = getItem(position);

            viewHolder.name.setText(item.getUser_name());
            viewHolder.comment.setText(item.getContent());
            viewHolder.riqi.setText(times(item.getCtime()));
//            Log.d("CommentActivity",item.getUser_name() +"++======"+item.getStarts());
            if (item.getStarts() != null){
