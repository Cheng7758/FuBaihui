...
import com.example.zhanghao.woaisiji.mvp.contract.DriverReviewContract;
import com.example.zhanghao.woaisiji.mvp.modle.CircleModel;
import com.example.zhanghao.woaisiji.mvp.modle.DriverReviewModel;
...
public class DriverReviewPresenter implements DriverReviewContract.Presenter{
	private DriverReviewModel reviewModel ;
	private DriverReviewContract.View view;
	private RespDriveReviewList respDriveReviewList;
	private List<CircleIndexBean.ListBean> circleLists;
	public int pager = 1;

	public DriverReviewPresenter(DriverReviewContract.View view){
		reviewModel = new DriverReviewModel();
		this.view = view;
	}
	...
	@Override
	public void deleteDriverReview(String circleId) {
	...
	* @throws
	...
	public void deleteCircle(final String circleId){
		reviewModel.deleteReview(new IDataRequestListener() {

			@Override
			public void loadSuccess(Object object) {
                if(view!=null){
                    view.update2DeleteDriverReview(circleId);
                }
			}
		});
	}
	...
	* @throws
	...
	public void addFavort(final int circlePosition){
		reviewModel.addFavort(new IDataRequestListener() {
...
//				FavortItem item = DatasUtil.createCurUserFavortItem();
	...
	* @throws
	...
	public void deleteFavort(final int circlePosition, final String favortId){
		reviewModel.deleteFavort(new IDataRequestListener() {
	...
	* @throws
	...
	public void addComment(final String content, final CommentConfig config){
		...
		reviewModel.addComment(new IDataRequestListener() {
	...
	* @throws
	...
	public void deleteComment(final int circlePosition, final String commentId){
		reviewModel.deleteComment(new IDataRequestListener(){
