...
//		if(DemoHelper.getInstance().getContactList().containsKey(nameText)){
	...
	private void getDataFromServer(final String toAddUsername) {
		// 获取服务器数据
		StringRequest stickyRequest = new StringRequest(Request.Method.POST, ServerAddress.URL_DRIVER_FRIEND, new Response.Listener<String>() {
			@Override
		...
		public View getView(int i, View view, ViewGroup viewGroup) {
			...
			viewHolder.btnIndicator.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					addContact(item.getId(),item.getNickname());
				}
			});
			return view;
		}
