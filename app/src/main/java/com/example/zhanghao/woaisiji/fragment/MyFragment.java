...
import com.example.zhanghao.woaisiji.activity.PersonalCollectionActivity;
...
import com.example.zhanghao.woaisiji.activity.PersonalOrderFormActivity;
...
import com.hyphenate.util.PerfUtils;
...
public class MyFragment extends BaseFragment implements View.OnClickListener {
    ...
    private RelativeLayout rl_home_my_page_mid_coupon,rl_home_my_page_mid_setting,
             rl_home_my_page_mid_kefu, rl_my_page_mid_referral_code,
             rl_my_page_mid_shipping_address,rl_my_page_mid_recruitment;
    ...
    private void setUserInfo() {
        ...
        Picasso.with(getActivity()).load(WoAiSiJiApp.getCurrentUserInfo().getPic())
