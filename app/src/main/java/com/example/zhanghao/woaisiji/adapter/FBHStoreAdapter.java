...
public class FBHStoreAdapter extends BaseAdapter {
    ...
    private final List<RespFBHStoreCategory.FBHStoreCategory> mListData;
   // private int selectPos;
    ...
    public FBHStoreAdapter(Context context, List<RespFBHStoreCategory.FBHStoreCategory> listData) {
        mContext = context;
        mListData = listData;
    }
    ...
    class ViewHolder{
        ...
        public void boundData(View convertView, List<RespFBHStoreCategory.FBHStoreCategory> mListData, int position) {
