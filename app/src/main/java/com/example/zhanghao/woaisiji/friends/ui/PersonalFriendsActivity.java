...
@SuppressLint("NewApi")
public class PersonalFriendsActivity extends BaseActivity {
    protected static final String TAG = "PersonalFriendsActivity";
...
//        fragments = new Fragment[]{contactListFragment};
...
//        intentFilter.addAction(RedPacketConstant.REFRESH_GROUP_RED_PACKET_ACTION);
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(action.equals(Constant.ACTION_GROUP_CHANAGED)){
                    if (EaseCommonUtils.getTopActivity(PersonalFriendsActivity.this).equals(GroupsActivity.class.getName())) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    if (ChatActivity.activityInstance != null && ChatActivity.activityInstance.toChatUsername != null &&
                        ...
                        Toast.makeText(PersonalFriendsActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_LONG)
                                .show();
    ...
    private void showConflictDialog() {
        ...
        if (!PersonalFriendsActivity.this.isFinishing()) {
            // clear up global variables
            try {
                if (conflictBuilder == null)
                    conflictBuilder = new android.app.AlertDialog.Builder(PersonalFriendsActivity.this);
                ...
                conflictBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //=========================
                        Intent intent = new Intent(PersonalFriendsActivity.this, MainActivity.class);
        ...
        if (!PersonalFriendsActivity.this.isFinishing()) {
            ...
            try {
                if (accountRemovedBuilder == null)
                    accountRemovedBuilder = new android.app.AlertDialog.Builder(PersonalFriendsActivity.this);
                ...
                accountRemovedBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //=========================
                        startActivity(new Intent(PersonalFriendsActivity.this, MainActivity.class));
                    }
                });
                ...
                DemoHelper.getInstance().logout(false,new EMCallBack() {
                    ...
                    public void onSuccess() {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                finish();
                                startActivity(new Intent(PersonalFriendsActivity.this, LoginActivity.class));
                            }
                        });
                    }
