 ...
 */
package com.example.zhanghao.woaisiji.friends.adapter;
...
import com.example.zhanghao.woaisiji.friends.domain.InviteMessage;
...
//						deleteContact(msg.getFrom());
						// 服务器添加好友
						acceptInvitationServer(msg.getFrom(),WoAiSiJiApp.getUid());
//						acceptInvitationServer(WoAiSiJiApp.uid,msg.getFrom());
                    }
                });
	...
	private void acceptInvitationServer(final String addWho, final String whoAdd) {
		StringRequest addFriendRequest = new StringRequest(Request.Method.POST, ServerAddress.URL_ADD_FRIEND, new Response.Listener<String>() {
			@Override
			...
			protected Map<String, String> getParams() throws AuthFailureError {
				...
				params.put("uid",whoAdd);
				params.put("add_who",addWho);
				params.put("who_add",whoAdd);
				return params;
			}
		};
		WoAiSiJiApp.mRequestQueue.add(addFriendRequest);
	}
	...
	public void deleteContact(final String userName) {
		String st1 = context.getResources().getString(R.string.deleting);
		final String st2 = context.getResources().getString(R.string.Delete_failed);
